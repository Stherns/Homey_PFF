...
4. Laisser le champ "Date de début" vide
    Ne Pas Entrer La Date de Debut    ${DATE DEBUT VIDE}

Ne Pas Entrer La Date de Debut
    [Arguments]    ${date_debut}
    Click Element     ${CHAMP DATE DEBUT}
    Input Text    ${CHAMP DATE DEBUT}    ${date_debut}

5. Saisir une date de fin valide
    Entrer La Date de Fin    ${DATE FIN2}
